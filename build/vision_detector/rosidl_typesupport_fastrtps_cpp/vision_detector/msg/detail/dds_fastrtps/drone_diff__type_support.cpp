...
#include "vision_detector/msg/detail/drone_diff__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const vision_detector::msg::DroneDiff & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  vision_detector::msg::DroneDiff & ros_message)
{
  // Member: target_yaw
  cdr >> ros_message.target_yaw;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = vision_detector::msg::DroneDiff;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_vision_detector
max_serialized_size_key_DroneDiff(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const vision_detector::msg::DroneDiff *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<vision_detector::msg::DroneDiff *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _DroneDiff__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const vision_detector::msg::DroneDiff *>(
...
static size_t _DroneDiff__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_DroneDiff(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _DroneDiff__callbacks = {
  "vision_detector::msg",
  "DroneDiff",
...
static rosidl_message_type_support_t _DroneDiff__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_DroneDiff__callbacks,
...
{
  return &vision_detector::msg::typesupport_fastrtps_cpp::_DroneDiff__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, vision_detector, msg, DroneDiff)() {
  return &vision_detector::msg::typesupport_fastrtps_cpp::_DroneDiff__handle;
}
