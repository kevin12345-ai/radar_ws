...
static const _GimbalInfo_type_support_symbol_names_t _GimbalInfo_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, vision_detector, msg, GimbalInfo)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, vision_detector, msg, GimbalInfo)),
  }
};
...
{
  return &::vision_detector::msg::rosidl_typesupport_cpp::GimbalInfo_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, vision_detector, msg, GimbalInfo)() {
  return get_message_type_support_handle<vision_detector::msg::GimbalInfo>();
}
